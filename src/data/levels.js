    ...
    levels: [
      {
        ...
        challenge: {
          ...
          initialCode: '# Usa print() para mostrar el mensaje\n',
          validation: (code, output) => output.trim() === 'Sistema activado',
          hint: 'print("Sistema activado")',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Puedes usar print() varias veces para mostrar múltiples líneas.' },
          { speaker: 'mentor', text: 'Cada print() genera una nueva línea en la salida.' },
        ],
        lesson: {
          concept: 'Múltiples print()',
          explanation: 'Puedes usar print() cuantas veces quieras.\nCada llamada imprime en una nueva línea.\nTambién puedes imprimir números sin comillas.\n\nprint() sin argumentos imprime una línea vacía.',
          example: 'print("Línea 1")\nprint("Línea 2")\nprint(42)\nprint(3.14)',
        ...
        challenge: {
          ...
          hint: 'Usa 3 print() separados, uno por línea',
      ...
      },
      {
        ...
        challenge: {
          ...
          initialCode: '# Crea la variable y muéstrala con print()\n',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Python tiene tipos: str (texto), int (enteros), float (decimales), bool (verdadero/falso).' },
        ],
        lesson: {
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Python puede hacer matemáticas. Los operadores básicos son +, -, *, /' },
          { speaker: 'mentor', text: 'El reactor necesita cálculos precisos para funcionar.' },
        ],
        lesson: {
          concept: 'Operadores aritméticos',
          explanation: 'Operadores matemáticos en Python:\n\n+ suma          10 + 3  → 13\n- resta         10 - 3  → 7\n* multiplicar   10 * 3  → 30\n/ dividir       10 / 3  → 3.333...\n// div. entera  10 // 3 → 3\n%  módulo       10 % 3  → 1\n** potencia     2 ** 3  → 8',
          example: 'a = 10\nb = 3\nprint(a + b)\nprint(a * b)\nprint(a // b)\nprint(a % b)',
          exampleOutput: '13\n30\n3\n1',
        },
        challenge: {
          ...
          hint: 'print(energia // consumo_modulo)',
          expectedOutput: '6',
        },
      },
      {
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Python tiene funciones de conversión: int(), float(), str(), bool().' },
        ],
        lesson: {
      ...
      },
      {
        ...
        challenge: {
          ...
          validation: (code, output) => code.includes('f"') && output.trim() === 'Vida: 85/100',
          hint: 'print(f"Vida: {hp}/{max_hp}")',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Python los ignora al ejecutar. Se escriben con # al inicio.' },
        ],
        lesson: {
          concept: 'Comentarios en Python',
    ...
    levels: [
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Python usa operadores que devuelven True o False.' },
        ],
        lesson: {
        ...
        challenge: {
          ...
          hint: 'print(nivel >= nivel_requerido)',
          expectedOutput: 'True',
        },
      },
      {
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'elif (abreviatura de "else if") te permite verificar múltiples condiciones.' },
          { speaker: 'mentor', text: 'Python las evalúa en orden: la primera que sea True se ejecuta.' },
        ],
        lesson: {
          concept: 'if-elif-else — Múltiples caminos',
          explanation: 'if condición1:\n    código 1\nelif condición2:\n    código 2\nelif condición3:\n    código 3\nelse:\n    código por defecto\n\nSolo se ejecuta UN bloque.\nSe evalúan en orden de arriba a abajo.\nPuedes tener cuantos elif necesites.',
          example: 'nota = 75\nif nota >= 90:\n    print("Excelente")\nelif nota >= 70:\n    print("Bueno")\nelif nota >= 50:\n    print("Regular")\nelse:\n    print("Insuficiente")',
          exampleOutput: 'Bueno',
        },
        challenge: {
          ...
          validation: (code, output) => code.includes('elif') && output.trim() === 'ALERTA',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'if energia > 50 and escudo:\n    print("Listo para combate")',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'El operador or requiere que AL MENOS UNA condición sea True.' },
      ...
      },
      {
        ...
        lesson: {
          ...
          explanation: 'not — invierte el valor:\n\nnot True  → False\nnot False → True\n\nSe puede combinar con and y or:\nif not es_peligroso and tiene_energia:\n    avanzar()',
      ...
      },
      {
        ...
        challenge: {
          ...
          validation: (code, output) => code.includes('elif') && code.includes('and') && output.trim() === 'Acceso operativo',
          hint: 'if rol == "admin":\n    print("Control total")\nelif rol == "operador" and clearance >= 5:\n    print("Acceso operativo")\nelse:\n    print("Acceso denegado")',
    ...
    levels: [
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'datos = [88, 92, 45, 67, 91, 34]\naltos = 0\nfor d in datos:\n    if d >= 80:\n        altos += 1\nprint(f"{altos} valores altos de {len(datos)}")',
    ...
    levels: [
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Las listas guardan múltiples valores en orden. Son la estructura más usada en Python.' },
        ],
        lesson: {
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Python tiene funciones integradas muy útiles para trabajar con listas.' },
        ],
        lesson: {
        ...
        challenge: {
          ...
          hint: 'print(max(lecturas))\nprint(min(lecturas))\nprint(sum(lecturas) // len(lecturas))',
          expectedOutput: '89\n23\n59',
        },
      },
      {
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'stats = {"hp": 100, "atk": 25, "def": 15}\nfor stat, val in stats.items():\n    print(f"{stat}: {val}")',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'posicion = (5, 10)\nprint(f"X: {posicion[0]}, Y: {posicion[1]}")',
      ...
      },
      {
        ...
        challenge: {
          ...
          validation: (code, output) => {
            ...
            return code.includes('def') && code.includes('contar_recursos') && out.includes('metal') && out.includes('3');
          },
          hint: 'def contar_recursos(items):\n    conteo = {}\n    for item in items:\n        if item in conteo:\n            conteo[item] += 1\n        else:\n            conteo[item] = 1\n    return conteo',
    ...
    levels: [
      {
        ...
        lesson: {
          ...
          explanation: 'Se definen con def:\n\ndef nombre():\n    código\n\nSe llaman por su nombre:\nnombre()\n\nVentajas:\n• Reutilización de código\n• Organización\n• Evitar repetición',
        ...
        challenge: {
          ...
          validation: (code, output) => code.includes('def') && code.includes('alerta') && output.trim() === 'ALERTA: Sistema activo\nALERTA: Sistema activo',
          hint: 'def alerta():\n    print("ALERTA: Sistema activo")\n\nalerta()\nalerta()',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'def presentar(nombre, rol):\n    print(f"{nombre} - {rol}")\n\npresentar("EVA", "IA")\npresentar("Core", "Sistema")',
        ...
        challenge: {
          ...
          validation: (code, output) => code.includes('def') && code.includes('nombre') && output.trim() === 'Agente: EVA (Nivel 10)',
          hint: 'def estado(nombre, nivel):\n    print(f"Agente: {nombre} (Nivel {nivel})")\n\nestado("EVA", 10)',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'def calcular_escudo(energia):\n    return energia * 2 + 10\n\nprint(calcular_escudo(25))',
          expectedOutput: '60',
        },
        decision: {
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'def potencia(base, exp=2):\n    return base ** exp\n\nprint(potencia(3))\nprint(potencia(2, 10))',
          exampleOutput: '9\n1024',
        },
        challenge: {
          ...
          validation: (code, output) => {
            const lines = output.trim().split('\n');
            return code.includes('def') && code.includes('= 0') && lines[0] === '100' && lines[1] === '50';
          },
          hint: 'def evaluar(puntos, bonus=0):\n    return puntos + bonus\n\nprint(evaluar(80, 20))\nprint(evaluar(50))',
          expectedOutput: '100\n50',
        },
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Las funciones Python pueden retornar múltiples valores a la vez como tupla.' },
        ],
        lesson: {
          concept: 'Retornar múltiples valores',
          explanation: 'Retornar varios valores:\n\ndef dividir(a, b):\n    cociente = a // b\n    resto = a % b\n    return cociente, resto\n\nc, r = dividir(10, 3)\n\nPython empaqueta los valores en una tupla\ny los desempaquetas con múltiples variables.',
          example: 'def stats(datos):\n    return min(datos), max(datos), sum(datos)\n\nmi, ma, su = stats([10, 20, 30])\nprint(f"Min: {mi}, Max: {ma}, Suma: {su}")',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'def mayores_que(datos, limite):\n    resultado = []\n    for d in datos:\n        if d > limite:\n            resultado.append(d)\n    return resultado\n\nprint(mayores_que([1, 5, 3, 8, 2, 9], 4))',
          exampleOutput: '[5, 8, 9]',
        },
        challenge: {
          ...
          validation: (code, output) => code.includes('def') && code.includes('return') && output.trim() === '[10, 20, 30]',
          hint: 'def duplicar_lista(datos):\n    resultado = []\n    for d in datos:\n        resultado.append(d * 2)\n    return resultado\n\nprint(duplicar_lista([5, 10, 15]))',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'def resumen(datos):\n    total = 0\n    for clave, valor in datos.items():\n        total += valor\n    return total\n\nrecursos = {"metal": 50, "cristal": 30}\nprint(f"Total: {resumen(recursos)}")',
        ...
        challenge: {
          ...
          validation: (code, output) => code.includes('def') && output.trim().includes('Zero') && output.trim().includes('elite') && output.trim().includes('150'),
          hint: 'def crear_agente(nombre, puntos):\n    rango = "elite" if puntos >= 100 else "normal"\n    return {"nombre": nombre, "puntos": puntos, "rango": rango}\n\nprint(crear_agente("Zero", 150))',
      ...
      },
      {
        ...
        challenge: {
          ...
          validation: (code, output) => code.includes('def doble') && code.includes('def sumar_diez') && output.trim() === '40',
          hint: 'def doble(n):\n    return n * 2\n\ndef sumar_diez(n):\n    return n + 10\n\nprint(sumar_diez(doble(15)))',
          expectedOutput: '40',
        },
      },
      {
        ...
        challenge: {
          ...
          validation: (code, output) => {
            const out = output.trim();
            return code.includes('def') && code.includes('reporte') && out.includes('5') && out.includes('37') && out.includes('7') && out.includes('3');
          },
          hint: 'def reporte(nums):\n    pos = 0\n    for n in nums:\n        if n > 0:\n            pos += 1\n    return {"total": len(nums), "suma": sum(nums), "promedio": sum(nums) // len(nums), "positivos": pos}',
