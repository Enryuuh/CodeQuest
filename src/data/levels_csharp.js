    ...
    levels: [
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Tu primera misión es simple: envía un mensaje al sistema usando Console.WriteLine().' },
        ],
        lesson: {
          concept: 'Console.WriteLine() — Salida de datos',
          explanation: 'La función Console.WriteLine() muestra información en la consola.\nTodo lo que pongas entre los paréntesis se mostrará en pantalla.\nLos textos (strings) van entre comillas dobles o simples.\n\nConsole.WriteLine("mensaje")',
          example: 'Console.WriteLine("Hola mundo");\nConsole.WriteLine("C// es genial");',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Puedes usar Console.WriteLine() varias veces para mostrar múltiples líneas.' },
          { speaker: 'mentor', text: 'Cada Console.WriteLine() genera una nueva línea en la salida.' },
        ],
        lesson: {
          concept: 'Múltiples Console.WriteLine()',
          explanation: 'Puedes usar Console.WriteLine() cuantas veces quieras.\nCada llamada imprime en una nueva línea.\nTambién puedes imprimir números sin comillas.\n\nConsole.WriteLine() sin argumentos imprime una línea vacía.',
          example: 'Console.WriteLine("Línea 1");\nConsole.WriteLine("Línea 2");\nConsole.WriteLine(42);\nConsole.WriteLine(3.14);',
        ...
        challenge: {
          ...
          hint: 'Usa 3 Console.WriteLine() separados, uno por línea;',
      ...
      },
      {
        ...
        challenge: {
          ...
          initialCode: '// Crea la variable y muéstrala con Console.WriteLine()\n',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'C// tiene tipos: str (texto), int (enteros), float (decimales), bool (verdadero/falso).' },
        ],
        lesson: {
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'C// puede hacer matemáticas. Los operadores básicos son +, -, *, /' },
        ...
        challenge: {
          ...
          hint: 'Console.WriteLine(energia // consumo_modulo);',
          expectedOutput: '6',
        },
      },
      {
        ...
        challenge: {
          ...
          hint: 'titulo = "CORE";\nversion = "2.1";\nConsole.WriteLine(titulo + " v" + version);',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Las f-strings son la forma moderna de formatear texto en C#.' },
        ...
        challenge: {
          ...
          hint: 'Console.WriteLine(f"Vida: {hp}/{max_hp}");',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: '// Reporte de recursos\noro = 500;\ngasto = 120;\nrestante = oro - gasto;\nConsole.WriteLine($"Oro restante: {restante}");',
        ...
        challenge: {
          ...
          hint: 'promedio = int((cpu + ram + disco) / 3);\nConsole.WriteLine($"Rendimiento: {promedio}%");',
    ...
    levels: [
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'C// usa operadores que devuelven true o false.' },
        ],
        lesson: {
        ...
        challenge: {
          ...
          hint: 'Console.WriteLine(nivel >= nivel_requerido);',
          expectedOutput: 'true',
        },
      },
      {
        ...
        challenge: {
          ...
          hint: 'if (energia > 50)\n    Console.WriteLine("Sistema estable");\nConsole.WriteLine("Check completado");',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'C// las evalúa en orden: la primera que sea true se ejecuta.' },
        ],
        lesson: {
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'if (energia > 50 && escudo)\n    Console.WriteLine("Listo para combate");',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'if (rango == "general" or nivel > 5)\n    Console.WriteLine("Comando autorizado");\nelse:\n    Console.WriteLine("Sin autorizacion");',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'bloqueado = false;\nif not bloqueado:\n    Console.WriteLine("Camino libre");\nelse:\n    Console.WriteLine("Camino bloqueado");',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'fruta = "manzana";\nif "ana" in fruta:\n    Console.WriteLine("Contiene ana");\n\nnumeros = [1, 2, 3, 4, 5];\nif 3 in numeros:\n    Console.WriteLine("El 3 está en la lista");',
        ...
        challenge: {
          ...
          hint: 'if ("admin" in password)\n    Console.WriteLine("Password debil");',
    ...
    levels: [
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'contador = 0;\nfor v in valores:\n    if (v > 10)\n        contador += 1;\nConsole.WriteLine($"Mayores a 10: {contador}");',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'datos = [88, 92, 45, 67, 91, 34];\naltos = 0;\nfor d in datos:\n    if (d >= 80)\n        altos += 1;\nConsole.WriteLine($"{altos} valores altos de {len(datos)}");',
        ...
        challenge: {
          ...
          hint: 'for t in temps:\n    if (t > 90)\n        Console.WriteLine("CRIT");\n        criticos += 1;\n    else if (t > 80)\n        Console.WriteLine("WARN");\n    else\n        Console.WriteLine("OK");\nConsole.WriteLine($"Criticos: {criticos}");',
          expectedOutput: 'OK\nWARN\nCRIT\nOK\nCRIT\nOK\nWARN\nCriticos: 2',
        },
      },
    ],
    ...
    levels: [
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'Las listas guardan múltiples valores en orden. Son la estructura más usada en C#.' },
        ],
        lesson: {
        ...
        challenge: {
          ...
          hint: 'sensores = [25, 30, 28, 35, 22];\nConsole.WriteLine(sensores[0]);\nConsole.WriteLine(sensores[-1]);',
          expectedOutput: '25\n22',
        },
      },
      {
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'Console.WriteLine(codigos[:3]);',
      ...
      },
      {
        ...
        story: [
          ...
          { speaker: 'mentor', text: 'C// tiene funciones integradas muy útiles para trabajar con listas.' },
        ],
        lesson: {
          ...
          example: 'notas = [85, 92, 78, 95, 88];\nConsole.WriteLine($"Max: {max(notas)}");\nConsole.WriteLine($"Min: {min(notas)}");\nConsole.WriteLine($"Suma: {sum(notas)}");\nConsole.WriteLine($"Promedio: {sum(notas) // len(notas)}");',
        ...
        challenge: {
          ...
          hint: 'Console.WriteLine(max(lecturas));\nConsole.WriteLine(min(lecturas));\nConsole.WriteLine(sum(lecturas) // len(lecturas));',
          expectedOutput: '89\n23\n59',
        },
      },
      {
        ...
        lesson: {
          ...
          example: 'agente = {\n    "nombre": "EVA",;\n    "nivel": 10,;\n    "activo": true;\n}\nConsole.WriteLine(agente["nombre"]);\nConsole.WriteLine(agente["nivel"]);',
          exampleOutput: 'EVA\n10',
        },
        challenge: {
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'msg = "  Hola Mundo  ";\nConsole.WriteLine(msg.strip());\nConsole.WriteLine(msg.strip().upper());\nConsole.WriteLine("a-b-c".split("-"));\nConsole.WriteLine("banana".count("a"));',
          exampleOutput: 'Hola Mundo\nHOLA MUNDO\n[\'a\', \'b\', \'c\']\n3',
        },
        challenge: {
          ...
          hint: 'partes = mensaje.split(":");\nConsole.WriteLine(partes[-1].upper());',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'posicion = (5, 10);\nConsole.WriteLine($"X: {posicion[0]}, Y: {posicion[1]}");',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'for e in equipo:\n    if (e["estado"] == "fallo")\n        Console.WriteLine($"FALLO: {e[\"nombre\"]}");',
    ...
    levels: [
      {
        ...
        lesson: {
          ...
          example: 'void saludar()\n    Console.WriteLine("Hola desde la funcion!");\n\nsaludar();\nsaludar();',
        ...
        challenge: {
          ...
          hint: 'void alerta()\n    Console.WriteLine("ALERTA: Sistema activo");\n\nalerta();\nalerta();',
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'void calcular_escudo(energia)\n    return energia * 2 + 10;\n\nConsole.WriteLine(calcular_escudo(25));',
          expectedOutput: '60',
        },
        decision: {
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'void evaluar(puntos, bonus=0)\n    return puntos + bonus;\n\nConsole.WriteLine(evaluar(80, 20));\nConsole.WriteLine(evaluar(50));',
          expectedOutput: '100\n50',
        },
      },
      {
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'sistema = "CORE";\n\ndef info():;\n    version = "2.1";\n    Console.WriteLine($"Sistema: {sistema} v{version}");\n\ninfo();',
      ...
      },
      {
        ...
        lesson: {
          ...
          example: 'void mayores_que(datos, limite)\n    resultado = [];\n    for d in datos:\n        if (d > limite)\n            resultado.append(d);\n    return resultado;\n\nConsole.WriteLine(mayores_que([1, 5, 3, 8, 2, 9], 4));',
          exampleOutput: '[5, 8, 9]',
        },
        challenge: {
      ...
      },
      {
        ...
        challenge: {
          ...
          hint: 'void doble(n)\n    return n * 2;\n\ndef sumar_diez(n):;\n    return n + 10;\n\nConsole.WriteLine(sumar_diez(doble(15)));',
          expectedOutput: '40',
        },
      },
      {
